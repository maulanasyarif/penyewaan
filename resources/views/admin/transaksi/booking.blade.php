                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mt-2">
                              <button id="btn-accept" class="btn btn-sm btn-primary" menu-id={{$transaksi->transaksi_details[0]->menuitem_id}} data-id={{$transaksi->id}}>Terima</button>
                              <button id="btn-reject" class="btn btn-sm btn-danger" menu-id={{$transaksi->transaksi_details[0]->menuitem_id}} data-id={{$transaksi->id}}>Tolak</button>
                          </div>
                        </div>
                    </div>
                </div>
